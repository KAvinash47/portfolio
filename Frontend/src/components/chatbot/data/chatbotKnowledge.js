...
export function buildKnowledgeBase() {
  ...
  const entries = [
    {
      id: 'intro',
      label: 'Tell me about Avinash',
      keywords: ['who is avinash', 'about avinash', 'about', 'background', 'summary', profile.name],
      reply: "Avinash Kumar is an aspiring Software Engineer proficient in C/C++ and AI-Web Integration. He is a first-year B.Tech Computer Science student at Poornima University, Jaipur, with a strong passion for technology, innovation, and creative problem-solving.",
    ...
    },
    {
      ...
      reply: "Avinash has several high-impact projects. The main highlights include an Enterprise PDF to CSV Pipeline, the Collab-Nest real-time platform, AI FIR analysis, and a Self-Driving Car simulation. Which one would you like to hear more about?",
    ...
    },
    {
      ...
      reply: "Avinash's tech stack is quite extensive. He works with JavaScript, Python, and C++ for languages. For backend, he uses Node.js, Express, and FastAPI with databases like PostgreSQL and Redis. He's also proficient in Cloud and DevOps tools like GCP, AWS, Docker, and Kubernetes.",
    ...
    },
    {
      ...
      reply: "Avinash is currently focused on building high-impact projects and has a versatile skill set that combines programming, AI automation, and web development. He has already completed several advanced certifications from IBM, Oracle, and AWS.",
    ...
    },
    {
      id: 'education',
      label: 'Education',
      keywords: ['education', 'college', 'degree', 'poornima', 'cgpa', 'study'],
      reply: "Avinash is pursuing a B-Tech in Computer Science from Poornima University, Jaipur. He maintains a strong focus on C/C++, Data Structures, Web Development, and AI Integration.",
      followUps: ['projects', 'experience', 'contact'],
      reaction: 'document',
    },
    {
      ...
      reply: "You can reach Avinash via email at k.avinash000001@gmail.com. You can also connect with him on LinkedIn or check out his latest code contributions on GitHub.",
  ...
  const fallback = {
    ...
    keywords: [],
    reply:
      "I only answer from Avinash's portfolio content. Try asking about projects, tech stack, experience, education, or contact details.",
